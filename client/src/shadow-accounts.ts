 ...
 *
 * The address is not recomputed client-side: the view returns the address stored on chain, which stays
 * authoritative for accounts deployed before the anonymizer moved to deriving addresses from the fixed
 * primer class.
 *
