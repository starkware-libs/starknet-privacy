...
// TODO: Consider enum? or mod?
pub(crate) const ACCOUNT_PHASE: u8 = 0;
pub(crate) const CHANNEL_PHASE: u8 = 1;
pub(crate) const SUBCHANNEL_PHASE: u8 = 2;
pub(crate) const DEPOSIT_PHASE: u8 = 3;
pub(crate) const NOTES_PHASE: u8 = 4;
pub(crate) const WITHDRAW_PHASE: u8 = 5;
...
pub(crate) impl ClientActionImpl of ClientActionTrait {
    ...
    fn intended_phase(self: @ClientAction) -> u8 {
        match self {
            ClientAction::Register(_) => ACCOUNT_PHASE,
            ClientAction::ReplaceKey(_) => ACCOUNT_PHASE,
            ClientAction::OpenChannel(_) => CHANNEL_PHASE,
            ClientAction::OpenSubchannel(_) => SUBCHANNEL_PHASE,
            ClientAction::Deposit(_) => DEPOSIT_PHASE,
            ClientAction::CreateNote(_) => NOTES_PHASE,
            ClientAction::UseNote(_) => NOTES_PHASE,
            ClientAction::Withdraw(_) => WITHDRAW_PHASE,
        }
    }
    ...
    fn assert_and_set_phase(self: @ClientAction, ref current_phase: u8) {
        ...
        if intended_phase == ACCOUNT_PHASE {
            // TODO: Change to current_phase += 1?
            current_phase = CHANNEL_PHASE;
        } else {
