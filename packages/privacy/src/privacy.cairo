...
pub mod Privacy {
    ...
    pub impl ServerImpl of IServer<ContractState> {
        fn apply_actions(
            ...
            self.collect_fee();
            if let Option::Some(depositor) = self._apply_actions(:actions) {
