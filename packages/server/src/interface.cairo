...
pub trait IServer<T> {
    ...
    ///
    /// #### Parameters
    /// - `user` (`ContractAddress`): The address whose encrypted private viewing key is being
    /// queried.
    ///
    /// #### Returns
    /// - (`felt252`): The encrypted private viewing key associated with the user, or zero if not
    /// registered.
    ///
    /// #### Preconditions
    /// None
