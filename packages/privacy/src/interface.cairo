...
pub trait IServer<T> {
    ...
    /// have an `privacy_invoke` selector for a metehod that returns a
    /// `Span<`[`DepositToOpenNoteInput`](privacy::objects::DepositToOpenNoteInput)`>`.
    ///
    /// #### Events Emitted
    ...
    /// when `_deposit_to_open_note` is executed for it.
    ///
    /// #### Reverts
    ...
    /// [`DepositToOpenNoteInput`](privacy::objects::DepositToOpenNoteInput) values:
