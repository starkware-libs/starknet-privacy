...
use snforge_std::{
    CheatSpan, EventSpyTrait, EventsFilterTrait, TokenTrait, cheat_transaction_version,
...
fn test_compile_client_actions_assertions() {
    ...
    let result = user.safe_compile_client_actions_without_cheat(client_actions: [].span());
    assert_panic_with_felt_error(:result, expected_error: errors::ZERO_TX_VERSION);
