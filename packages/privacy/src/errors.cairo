...
pub const INVALID_AUDITOR_PUBLIC_KEY: felt252 = 'INVALID_AUDITOR_PUBLIC_KEY';
...
pub const EMPTY_COMPUTE_RESULT: felt252 = 'EMPTY_COMPUTE_RESULT';
pub const UNDEPOSITED_OPEN_NOTES: felt252 = 'UNDEPOSITED_OPEN_NOTES';
pub const INVALID_PUBLIC_KEY: felt252 = 'INVALID_PUBLIC_KEY';
pub const SCREENING_REQUIRED: felt252 = 'SCREENING_REQUIRED';
pub const UNEXPECTED_SCREENING: felt252 = 'UNEXPECTED_SCREENING';
pub const SCREENING_FUTURE_DATED: felt252 = 'SCREENING_FUTURE_DATED';
pub const SCREENING_EXPIRED: felt252 = 'SCREENING_EXPIRED';
pub const SCREENING_INVALID_SIGNATURE: felt252 = 'SCREENING_INVALID_SIGNATURE';
pub const MULTIPLE_SCREENING_SUBJECTS: felt252 = 'MULTIPLE_SCREENING_SUBJECTS';
pub const INVALID_ASSOCIATED_ADDRESSES: felt252 = 'INVALID_ASSOCIATED_ADDRESSES';
pub const NO_ASSOCIATED_ADDRESS: felt252 = 'NO_ASSOCIATED_ADDRESS';
