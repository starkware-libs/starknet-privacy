...
pub mod Privacy {
    ...
    use privacy::actions::{
        ...
        PrepareInvokeInput, ReadAssertInput, ServerAction, SetViewingKeyInput, TransferFromInput,
    ...
    pub(crate) impl ClientInternalImpl of ClientInternalTrait {
        ...
        fn main(
            ...
            for client_action in client_actions {
                ...
                let (actions, should_execute) = match *client_action {
                    ...
                    ClientAction::PrepareInvoke(input) => (self.prepare_invoke(:input), false),
                };
                if should_execute {
        ...
        /// Prepares an invoke action by forwarding the contract address and calldata as a
        /// server-side Invoke action.
        fn prepare_invoke(self: @ContractState, input: PrepareInvokeInput) -> Array<ServerAction> {
            input.assert_valid();
            let PrepareInvokeInput { contract_address, calldata } = input;
    ...
    pub impl ServerInternalImpl of ServerInternalTrait {
        ...
        fn _apply_invoke(
            ...
            call_contract_syscall(
                ...
                entry_point_selector: INVOKE_SELECTOR,
                calldata: calldata,
            )
                .unwrap_syscall();
        }
