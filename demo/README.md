...
- **Proof provider** — With `VITE_PROVING_SERVICE_URL` set, uses the remote proving service; otherwise `NoValidateProofProvider` calls `execute_view` directly (mock, no real proof)
