...
fn test_create_note_twice() {
    ...
    let note_id_3 = user_1
        .create_and_fill_open_note_e2e(create_note_input: note_3, amount: open_note_amount, :token);
    ...
    let note_id_4 = user_1
        .create_and_fill_open_note_e2e(create_note_input: note_4, amount: open_note_amount, :token);
...
fn test_create_open_note_stores_correctly() {
    ...
    let note_id = user_1.create_and_fill_open_note_e2e(:create_note_input, :amount, :token);
...
fn test_use_deposited_open_note(open_note_self: bool) {
    ...
    user_1.cheat_create_filled_open_note(:create_note_input, :amount);
...
fn test_use_multiple_deposited_open_notes() {
    ...
    user_1.cheat_create_filled_open_note(create_note_input: create_note_input_1, amount: amount_1);
    user_1.cheat_create_filled_open_note(create_note_input: create_note_input_2, amount: amount_2);
...
fn test_use_mixed_open_and_enc_notes() {
    ...
    user_1.cheat_create_filled_open_note(create_note_input: open_note_input, amount: open_amount);
...
fn test_create_open_note_decrypt_recipient_addr() {
    ...
    let mut spy_events = spy_events();
    user_1.create_and_fill_open_note_e2e(:create_note_input, :amount, :token);
...
fn test_internal_actions() {
    ...
    user_1.cheat_create_filled_open_note(create_note_input: create_open_note_input, :amount);
    test.privacy.increase_token_balance(:token, :amount);
    let nullifier = user_2.compute_nullifier(sender: user_1, :token_addr, :index);
...
fn test_create_open_note_as_single_action() {
    ...
    let create_note_input = user
        .new_open_note_with_generated_random(
            recipient: user, :token_addr, index: 0, depositor: test.privacy.echo_executor,
        );
...
fn test_create_note_at_existing_note_id(initial_is_open: bool, colliding_is_open: bool) {
    ...
    if initial_is_open {
        user_1.cheat_create_filled_open_note(create_note_input: open_note_input, :amount);
    } else {
        user_1.cheat_create_enc_note_e2e(create_note_input: enc_note_input);
    }
...
fn test_deposit_to_open_note_twice() {
    ...
    let note_id_a = user_1
        .create_and_fill_open_note_e2e(create_note_input: create_note_input_a, :amount, :token);
