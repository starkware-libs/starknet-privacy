...
use privacy::tests::test_utils::{PrivacyCfgTrait, Test, TestTrait, UserTrait, decrypt_channel_info};
use privacy::utils::{
...
fn test_create_note_twice() {
    ...
    user_1.privacy.mock_create_note(note: enc_note_1);
...
fn test_create_note_decrypt_amount() {
    ...
    let note = user_1.new_note(recipient: user_2, :token, :amount, index: note_index);
    let enc_note = user_1.create_note(:note);
    user_1.privacy.mock_create_note(note: enc_note);
...
fn test_deposit() {
    ...
    user.privacy.mock_create_note(note: enc_note_1);
...
fn test_use_note_find_nullifier() {
    ...
    assert_eq!(nullifier, expected_nullifier);
    assert_eq!(note_token, token);
    user_2.privacy.mock_use_note(nullifier: expected_nullifier);
