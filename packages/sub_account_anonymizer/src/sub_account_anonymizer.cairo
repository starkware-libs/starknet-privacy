...
pub trait ISubAccountAnonymizer<T> {
    ...
    ///   open note's `token` (a zero-amount deposit would be rejected by the privacy contract).
    ...
    impl InternalImpl of InternalTrait {
        ...
        fn collect_open_notes(
            ...
            for note in open_notes {
                ...
                // A zero-amount open-note deposit would be rejected by the privacy contract.
