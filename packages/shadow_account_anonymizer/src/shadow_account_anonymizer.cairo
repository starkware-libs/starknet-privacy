...
/// Test builds deploy `PrimerMock`, whose class hash differs from the cemented on-chain one;
/// `test_primer_flow` asserts this constant matches whichever of the two the build deploys.
#[cfg(target: "test")]
pub const PRIMER_CLASS_HASH: ClassHash =
    0x07cfc478396a03576e140b75a8e00773f50e18b07182617d1475d22e9e68bf45
    .try_into()
    .unwrap();
