...
fn make_token_amount(token: ContractAddress, amount: u128) -> TokenAmount {
...
fn test_ekubo_privacy_invoke_assert_zero_router() {
    ...
    let result = helper
        .safe_privacy_invoke(
            ...
            token_amount: make_token_amount(input_token.contract_address(), DEFAULT_AMOUNT),
            :pool_key,
            minimum_received: 0,
            skip_ahead: 0,
            note_id: 'note',
...
#[test]
fn test_ekubo_privacy_invoke_assert_zero_token() {
    let (helper, mock_router) = deploy_helper_with_router();
    let input_token = new_token();
    let output_token = new_token();
    let pool_key = pool_key_for_tokens(
...
#[test]
fn test_ekubo_privacy_invoke_assert_negative_amount() {
    let (helper, mock_router) = deploy_helper_with_router();
    let input_token = new_token();
    let output_token = new_token();
    let pool_key = pool_key_for_tokens(
    ...
    let result = helper
        .safe_privacy_invoke(
            ...
            token_amount: TokenAmount {
                token: input_token.contract_address(),
                amount: i129 { mag: DEFAULT_AMOUNT, sign: true },
            },
            :pool_key,
            minimum_received: 0,
            skip_ahead: 0,
...
fn test_ekubo_privacy_invoke_assert_zero_in_amount() {
    ...
    let result = helper
        .safe_privacy_invoke(
            router_addr: mock_router,
            token_amount: make_token_amount(input_token.contract_address(), 0),
            :pool_key,
            minimum_received: 0,
            skip_ahead: 0,
            note_id: 'note',
...
fn test_ekubo_privacy_invoke_assert_token_mismatch_pool() {
    ...
    let result = helper
        .safe_privacy_invoke(
            router_addr: mock_router,
            token_amount: make_token_amount(token_c.contract_address(), DEFAULT_AMOUNT),
            :pool_key,
            minimum_received: 0,
            skip_ahead: 0,
            note_id: 'note',
...
fn test_ekubo_privacy_invoke_assert_zero_out_amount() {
    ...
    let result = helper
        .safe_privacy_invoke(
            router_addr: mock_router,
            token_amount: make_token_amount(input_token.contract_address(), amount),
            :pool_key,
            minimum_received: 0,
            skip_ahead: 0,
            note_id: 'note',
