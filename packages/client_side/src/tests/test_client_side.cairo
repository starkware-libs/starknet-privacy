    ...
    let result = user_1
        .transfer(
            notes_to_use: array![
                ...
                .span(),
            notes_to_create: array![NoteTrait::new(recipient: user_2.address, :token, amount: 2)]
                .span(),
        );
    ...
    let result = user_1
        .transfer(
            ...
            notes_to_create: array![
                NoteTrait::new(recipient: user_2.address, :token, amount: 1),
                NoteTrait::new(recipient: user_2.address, :token, amount: 1),
                NoteTrait::new(recipient: user_3.address, :token, amount: 8),
            ]
                .span(),
        );
    let expected_result = ([].span(), [].span());
    ...
    let result = user_1
        .transfer(
            notes_to_use: array![
                ...
                .span(),
            notes_to_create: array![NoteTrait::new(recipient: user_1.address, :token, amount: 2)]
                .span(),
        );
    let expected_result = ([].span(), [].span());
    assert_eq!(result, expected_result);
...
fn test_transfer_assertions() {
    ...
    let result = user_1
        .safe_transfer(
            ...
            notes_to_create: array![NoteTrait::new(recipient: user_2.address, :token, amount: 1)]
                .span(),
        );
    ...
    let result = user_1
        .safe_transfer(
            notes_to_use: array![NotePathTrait::new(channel_index: 0, note_index: 0)].span(),
            notes_to_create: array![NoteTrait::new(recipient: user_2.address, :token, amount: 0)]
                .span(),
        );
