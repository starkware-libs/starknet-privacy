...
fn test_deposit_to_open_note() {
    ...
    let (note_id, actions) = user
        .internal_create_and_deposit_to_open_note(:create_note_input, :amount);
    ...
    assert_eq!(deposited_note.depositor, echo_executor);
...
fn test_deposit_to_open_note_assertions() {
    ...
    let bad_deposit = test
        .privacy
        ._deposit_to_open_note_actions(note_id: note_id_deposited, :token_addr, :amount);
...
fn test_apply_invoke_swap() {
    ...
    assert_eq!(deposited_note.depositor, executor_addr);
