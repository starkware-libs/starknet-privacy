...
fn test_transfer_assertions() {
    ...
    let encryption_payload = EncryptionPayload { amount: 1, salt: user_1.get_salt() };
    let create_note_input = CreateNoteInput {
        ...
        token: token_address,
        index: 0,
        encryption_payload: Some(encryption_payload),
    };
    ...
    let result = user_1
        .safe_transfer(
            ...
            notes_to_create: [
                CreateNoteInput {
                    encryption_payload: Some(
                        EncryptionPayload { amount: Zero::zero(), ..encryption_payload },
                    ),
                    ..create_note_input,
                }
            ]
    ...
    let result = user_1
        .safe_transfer(
            ...
            notes_to_create: [
                CreateNoteInput {
                    encryption_payload: Some(EncryptionPayload { salt: 0, ..encryption_payload }),
                    ..create_note_input,
                }
            ]
                .span(),
    ...
    let result = user_1
        .safe_transfer(
            ...
            notes_to_create: [
                CreateNoteInput {
                    encryption_payload: Some(EncryptionPayload { salt: 1, ..encryption_payload }),
                    ..create_note_input,
                }
            ]
                .span(),
        ...
        .safe_transfer(
            ...
            notes_to_create: [
                CreateNoteInput {
                    encryption_payload: Some(
                        EncryptionPayload {
                            salt: TWO_POW_120.try_into().unwrap(), ..encryption_payload,
                        },
                    ),
                    ..create_note_input,
                }
...
fn test_create_note_twice() {
    ...
    let create_note_3_actions = user_1.internal_create_note(note: note_3);
    assert_eq!(create_note_3_actions, user_1.note_to_server_actions(note: note_3));
    ...
    let create_note_4_actions = user_1.internal_create_note(note: note_4);
    assert_eq!(create_note_4_actions, user_1.note_to_server_actions(note: note_4));
    ...
    let create_note_5_actions = user_1.internal_create_note(note: note_5);
    assert_eq!(create_note_5_actions, user_1.note_to_server_actions(note: note_5));
    user_1.privacy.execute_actions(actions: create_note_5_actions);

    // Verify all note IDs are unique.
    let (note_id_1, expected_note_1) = user_1.compute_note(note: note_1);
    let (note_id_2, expected_note_2) = user_1.compute_note(note: note_2);
    let (note_id_3, expected_note_3) = user_1.compute_note(note: note_3);
    let (note_id_4, expected_note_4) = user_1.compute_note(note: note_4);
    let (note_id_5, expected_note_5) = user_1.compute_note(note: note_5);
...
fn test_create_note_zero_recipient_addr() {
    ...
    let result = user_1.safe_create_note(:note);
    assert_panic_with_felt_error(:result, expected_error: errors::ZERO_RECIPIENT_ADDR);
...
fn test_client_execute_writes() {
    ...
    let create_note = ClientAction::CreateNote(
        CreateNoteInput {
            ...
            token: token_address,
            index: index + 1,
            encryption_payload: Some(EncryptionPayload { amount: amount / 2, salt }),
        },
    );
