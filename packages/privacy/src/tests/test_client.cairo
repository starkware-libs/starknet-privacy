...
fn test_transfer_many_to_one() {
    ...
    user_1.open_channel_e2e(recipient: user_2);
    user_2.open_channel_e2e(recipient: user_1);
    user_3.open_channel_e2e(recipient: user_1);
    user_1.open_subchannel_e2e(recipient: user_2, :token, index: 0);
    user_2.open_subchannel_e2e(recipient: user_1, :token, index: 0);
    user_3.open_subchannel_e2e(recipient: user_1, :token, index: 0);
    let amount = 1;
    let note_index = 0;
    let note = user_2
        .new_note_with_generated_random(recipient: user_1, :token, :amount, index: note_index);
...
fn test_transfer_many_to_many() {
    ...
    user_3.register_e2e();
    user_1.open_channel_e2e(recipient: user_3);
    user_2.open_channel_e2e(recipient: user_3);
    user_3.open_channel_e2e(recipient: user_1);
    user_3.open_channel_e2e(recipient: user_2);
    user_1.open_subchannel_e2e(recipient: user_3, :token, index: 0);
    user_2.open_subchannel_e2e(recipient: user_3, :token, index: 0);
    user_3.open_subchannel_e2e(recipient: user_1, :token, index: 0);
    user_3.open_subchannel_e2e(recipient: user_2, :token, index: 0);
    let amount = 1;
    let note_index = 0;
    let note = user_1
...
fn test_deposit() {
    ...
    user.open_subchannel_e2e(recipient: user, :token, index: 0);
    let index = 0;
    let note = user.new_note_with_generated_random(recipient: user, :token, :amount, :index);
    ...
    let note = NewNote { index, random, ..note };
    let actions = user.deposit(new_note: note);
    let enc_note_2 = user.compute_enc_note(recipient: user, :token, :index, :amount, :random);
    let storage_path_felt_note = map_entry_address(
        map_selector: selector!("notes"), keys: [enc_note_2.id].span(),
    );
    let expected_actions = [
...
fn test_deposit_assertions() {
    ...
    let token = test.mock_new_token();
    let amount = 100;
    let note = user.new_note_with_generated_random(recipient: user, :token, :amount, index: 0);
...
fn test_use_note_multiple_notes() {
    ...
    user_1.open_channel_e2e(recipient: user_2);
    user_2.open_subchannel_e2e(recipient: user_2, :token, index: 0);
    user_1.open_subchannel_e2e(recipient: user_2, :token, index: 0);
    let amount_1 = 1;
    let amount_2 = 2;
    let note_1 = user_1
