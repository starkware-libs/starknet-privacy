...
pub mod Privacy {
    ...
    struct Storage {
        ...
        /// Map of open-note depositor addresses to how the pool handles their deposits. An absent
        /// entry reads as `Required`, so only listed addresses are stored.
    ...
    pub impl AdminImpl of IAdmin<ContractState> {
        ...
        fn set_open_note_screening_policy(
            ...
            // `Required` is the default variant, so writing it zeroes the slot — the entry is
