...
/// Flow 3: open note chain — A creates open note for B, depositor funds it, B transfers to C,
...
/// Flow 6: open note round trip — depositor opens channel to user_a and creates open note for
...
/// Flow 7: create open note and deposit to it in the same tx.
