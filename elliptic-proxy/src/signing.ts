...
// hash and signature stay byte-compatible with the reference vectors in
// tests/fixtures/screening-vectors.json (regenerate with
// scripts/gen-screening-vectors.mjs).
//
...
// starknet_keccak("StarknetDomain"(...)) — the canonical SNIP-12 revision-1
// domain type hash (also hardcoded in OpenZeppelin's Cairo snip12 utilities).
