...
use privacy::objects::{EncPrivateKeyTrait, Note, NoteTrait, ToServerActionsTrait};
...
fn test_execute_deposit_to_open_note_assertions() {
    ...
    // Test 1: ZERO_NOTE_ID - Try to deposit with zero note_id.
    ...
    // Test 2: ZERO_AMOUNT - Try to deposit with zero amount.
    ...
    // Test 3: NOTE_NOT_FOUND - Try to deposit to a note that doesn't exist.
    ...
    // Test 4: NOTE_NOT_OPEN - Write an encrypted note (salt >= 2), try to deposit to it.
    ...
    // Test 5: NOTE_ALREADY_DEPOSITED - Deposit to an open note, then try to deposit again.
    ...
    // Test 6: CALLER_NOT_DEPOSITOR - Create open note with depositor A, caller is depositor B.
