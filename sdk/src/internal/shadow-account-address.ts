 ...
 *
 * Returned as a felt in hex with no leading zeros, the one spelling of an address this SDK compares
 * and transmits — unlike the commitments above, which are hash inputs and stay felts.
 */
