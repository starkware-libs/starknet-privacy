...
pub mod constants {
    ...
    /// [`ComputeAndInvoke`](privacy::actions::ClientAction::ComputeAndInvoke) client action.
...
/// Wraps `panic_data` from an external call (captured during client compilation), with
/// `ERR_WRAPPER`.
