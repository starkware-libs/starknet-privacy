...
pub struct SetViewingKeyInput {
    /// A random value used to encrypt the private key for the auditor. Generated by the
    /// user.
    pub random: felt252,
}
...
pub struct CreateOpenNoteInput {
    ...
    /// A random value used to encrypt the recipient address for the auditor. Generated
    /// by the sender.
    pub random: felt252,
}
...
pub struct WithdrawInput {
    ...
    pub amount: u128,
    /// A random value used to encrypt the user address for the auditor. Generated by the
    /// user.
    pub random: felt252,
}
