...
fn test_encrypt_private_key_decrypt() {
    ...
    let auditing_entity_private_key = hash(['AUDITING_ENTITY_PRIVATE_KEY'].span());
    let auditing_entity_public_key = derive_public_key(private_key: auditing_entity_private_key);
    let enc_private_key = encrypt_private_key(
        ephemeral_secret: random, :auditing_entity_public_key, :private_key,
    );
    let dec_private_key = decrypt_private_key(:enc_private_key, :auditing_entity_private_key);
...
fn test_encrypt_user_addr_decrypt() {
    ...
    let enc_user_addr = encrypt_user_addr(
        ephemeral_secret: random, :auditing_entity_public_key, :user_addr,
    );
    let dec_user_addr = decrypt_enc_user_addr(:enc_user_addr, :auditing_entity_private_key);
