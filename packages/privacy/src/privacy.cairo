...
pub mod Privacy {
    ...
    use privacy::objects::{
        BalanceOp, ClientAction, CreateNoteInput, DepositInput, EncChannelInfo, EncChannelInfoTrait,
        EncPrivateKey, EncSubchannelInfo, OpenChannelInput, OpenSubchannelInput, ServerAction,
        SetViewingKeyInput, TokenBalances, TokenBalancesTrait, UseNoteInput, WithdrawInput,
    };
