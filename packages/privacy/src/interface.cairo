...
pub trait IClient<T> {
    ...
    /// check if the transaction can be executed. It validates that the execution info has zero tip,
    /// and zero resource prices, then returns [`VALIDATED`](starknet::VALIDATED).
    ///
    /// #### Parameters
