...
use privacy::tests::utils_for_tests::{
    PrivacyCfgTrait, Test, TestTrait, UserTrait, VesuComponentsTrait,
};
...
fn test_e2e_vesu_invoke() {
    ...
    test
        ...
        .execute_actions_e2e(
            ...
            client_actions: [
                ...
                ClientAction::Deposit(DepositInput { token: underlying_token_addr, amount }),
                ClientAction::CreateEncNote(create_note_0),
            ]
                .span(),
        );
    ...
    let invoke_deposit = vesu
        .invoke_vesu_deposit_external_input(in_amount: amount, note_id: open_note_vault_id);
    test
        .privacy
        .execute_actions_e2e(
            user_addr: user.address,
            ...
            client_actions: [
                ...
                ClientAction::UseNote(
                    UseNoteInput {
                        channel_key: channel_key_self, token: underlying_token_addr, index: 0,
                    },
                ),
    ...
    let invoke_withdraw = vesu
        .invoke_vesu_withdraw_external_input(in_amount: amount, note_id: open_note_underlying_id);
    test
        .privacy
        .execute_actions_e2e(
            user_addr: user.address,
            ...
            client_actions: [
                ClientAction::UseNote(
                    UseNoteInput { channel_key: channel_key_self, token: vault_addr, index: 0 },
                ),
                ClientAction::CreateOpenNote(create_open_underlying),
                ClientAction::Withdraw(
                    WithdrawInput {
                        to_addr: helper_addr, token: vault_addr, amount, random: user.get_random(),
                    },
                ),
