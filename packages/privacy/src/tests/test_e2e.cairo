...
fn test_e2e_actions_twice() {
    ...
    token_1.supply(address: test.privacy.swap_executor.address, :amount);
    token_1
        .approve(
            owner: test.privacy.swap_executor.address,
            spender: test.privacy.address,
    ...
    let echo_invoke = user_1
        .invoke_external_echo_deposits(
            [
                DepositToOpenNoteInput { note_id: open_id_1, token: token_1_addr, amount: half },
                DepositToOpenNoteInput { note_id: open_id_2, token: token_1_addr, amount: half },
            ]
                .span(),
        );
    test
