...
describe("Privacy StarkNet integration (custom pool)", () => {
  ...
  it("preflight returns a valid SetupRequirement", async () => {
    ...
    // Must be BigInt: a hex number literal this large overflows to float in JS and breaks starknet.js hash (BigInt(float) throws).
    const viewingKey = 0x254055e37555fd981daf35700e046e42980f4e041d7aaec4886c0c1a46a06n;
  ...
  it("deposit to custom pool for depositor address", async () => {
    const transfers = createPrivateTransfers({
      ...
      viewingKeyProvider: { getViewingKey: () => 0x254055e37555fd981daf35700e046e42980f4e041d7aaec4886c0c1a46a06n },
