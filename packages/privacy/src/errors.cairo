...
pub const DEPOSITOR_MISMATCH: felt252 = 'DEPOSITOR_MISMATCH';
...
pub const INVOKE_RETURN_DESERIALIZE_ERROR: felt252 = 'INVOKE_RETURN_DESERIALIZE_ERROR';
pub const INVOKE_RETURN_EXTRA_DATA: felt252 = 'INVOKE_RETURN_EXTRA_DATA';
pub const UNFILLED_OPEN_NOTES: felt252 = 'UNFILLED_OPEN_NOTES';
