...
pub(crate) fn compute_message_hash(validation: @DepositorValidation, signer: felt252) -> felt252 {
    snip12_message_hash(SNIP12_NAME, SNIP12_VERSION, signer, validation.hash_struct())
}
...
pub(crate) fn compute_call_set_hash(signer: ContractAddress, calls: Span<Call>) -> felt252 {
    snip12_message_hash(
        CALL_SET_SNIP12_NAME, CALL_SET_SNIP12_VERSION, signer.into(), CallSet { calls }.hash_struct(),
    )
}
