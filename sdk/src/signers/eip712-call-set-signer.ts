 ...
 *   hashStruct(CallSet) = keccak256(CALL_SET_TYPE_HASH, hashCallArray(calls))
...
const CALL_SET_TYPE_HASH = 0x00e0d1180501b61e32e630264491a7c9a611d81184f8a1cf1e41e1343bb396dfn;
...
const hashCallSet = (calls: Call[]): bigint => keccakFelts(CALL_SET_TYPE_HASH, hashCallArray(calls));
...
function domainSeparator(snChainName: string, account: bigint, evmChainId: bigint): bigint {
  ...
  return keccakFelts(EIP712_DOMAIN_TYPE_HASH, nameHash, VERSION_HASH, evmChainId, account & MASK_128);
}
