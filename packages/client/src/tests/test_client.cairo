...
fn test_withdraw_note_not_found() {
    ...
    let mut user_1_addr_user_2_private_key = user_1;
    user_1_addr_user_2_private_key.private_key = user_2.private_key;
    let result = user_1_addr_user_2_private_key
        .safe_withdraw(withdrawal_target: user_3.address, :note_to_withdraw);
    assert_panic_with_felt_error(:result, expected_error: errors::NOTE_NOT_FOUND);

    // Catch NOTE_NOT_FOUND (wrong private key).
    let mut user_2_addr_user_1_private_key = user_2;
    user_2_addr_user_1_private_key.private_key = user_1.private_key;
    let result = user_2_addr_user_1_private_key
        .safe_withdraw(withdrawal_target: user_3.address, :note_to_withdraw);
    assert_panic_with_felt_error(:result, expected_error: errors::NOTE_NOT_FOUND);
