...
const transfers = createPrivateTransfers({
  user: account, // or { address, signer } if you don't have a full Account
...
| ------------------------- | --------------------------------- | ------------------------------------------------------------------------------------------ |
| `user`                    | `PrivateTransfersUser`            | `{ address, signer }` used to sign proof invocations. A full `Account` is also assignable. |
