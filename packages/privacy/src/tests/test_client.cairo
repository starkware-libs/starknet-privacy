...
fn test_use_deposited_open_note(open_note_self: bool) {
    ...
    let create_note_input = user_1
        .new_open_note_with_generated_random(
            recipient: user_2, :token_addr, :index, depositor: test.echo_executor,
        );
    user_1.cheat_create_open_note_e2e(:create_note_input);
    ...
    test
        .privacy
        .fund_and_cheat_invoke_echo(executor: test.echo_executor, :token, :note_id, :amount);
...
fn test_use_multiple_deposited_open_notes() {
    ...
    let create_note_input_1 = user_1
        .new_open_note_with_generated_random(
            recipient: user_2, :token_addr, index: 0, depositor: test.echo_executor,
        );
    let create_note_input_2 = user_1
        .new_open_note_with_generated_random(
            recipient: user_2, :token_addr, index: 1, depositor: test.echo_executor,
        );
    ...
    test
        .privacy
        .fund_and_cheat_invoke_echo(
            executor: test.echo_executor, :token, note_id: note_id_1, amount: amount_1,
        );
    test
        .privacy
        .fund_and_cheat_invoke_echo(
            executor: test.echo_executor, :token, note_id: note_id_2, amount: amount_2,
        );
...
fn test_use_mixed_open_and_enc_notes() {
    ...
    test
        .privacy
        .fund_and_cheat_invoke_echo(
            executor: test.echo_executor, :token, note_id: open_note_id, amount: open_amount,
        );
...
fn test_execute_use_note_swap() {
    ...
    let expected_eventcheat_invoke_echo = events::OpenNoteDeposited {
    ...
    assert_expected_event_emitted(
        ...
        expected_event: expected_eventcheat_invoke_echo,
...
fn test_internal_actions() {
    ...
    let mut user_1 = test.new_user();
    let mut user_2 = test.new_user();
    let depositor = test.echo_executor;
    let token = test.new_token();
    let token_addr = token.contract_address();
    user_2.set_viewing_key_e2e();
...
#[test]
fn testcheat_invoke_echo_twice() {
    ...
    token.supply(address: test.echo_executor, :amount);
    token.approve(owner: test.echo_executor, spender: test.privacy.address, amount: amount.into());
    let result = test
        .privacy
        .safe_invoke_echo(executor: test.echo_executor, :note_id, :token_addr, :amount);
