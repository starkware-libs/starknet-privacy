...
/// Flow 2: open note funded with a large amount, recipient splits it into enc notes for two others.
...
/// Flow 4: two open notes funded by different depositors; both recipients transfer to a common
...
/// Flow 5: same depositor funds multiple open notes for different recipients.
